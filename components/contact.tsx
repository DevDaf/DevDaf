...
export function Contact() {
  return (
    <section
      id="contact"
      className="relative px-6 py-32 md:px-12 lg:px-16 xl:px-20"
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <ScrollReveal delay={200}>
              <p className="mb-10 max-w-lg text-lg leading-relaxed text-muted-foreground">
                ...
                can grow, contribute, and build great user experiences. Whether
                you have a job opening, a project idea, or just want to say hi,
          ...
          <div className="space-y-4">
            <ScrollReveal delay={200}>
              <div className="rounded-lg border border-border/50 bg-card/30 p-6 backdrop-blur-sm transition-all hover:border-primary/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                      Looking for a frontend developer role in a collaborative
                      team where I can keep growing.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-lg border border-border/50 bg-card/30 p-6 backdrop-blur-sm transition-all hover:border-primary/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                      Open to remote opportunities and relocation. Flexible with
